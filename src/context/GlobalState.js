...
const GlobalState = (props)=>{
    ...
    return (
        <Context.Provider value={{users , setusers , blogs , setblogs , subscribers , setsubscribers , orders , setorders , products , setproducts , getAllProducts , sell , scrap ,  orders, adminToken , setadminToken}}>
            {props.children}
        </Context.Provider>
    )
}
